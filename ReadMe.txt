...
4. datagenT01_M_Multi.R
   - Function used to generate recurrent events for "NDE NIE from Simulation I" and "NDE NIE from Simulation II"

5. datagenT01_M_CD4.R
   - Function used to generate recurrent events for "CPCRA NDE NIE Plot"
